...
class Schema {
  ...
  static courierSignupSchema() {
    return Joi.object({
      ...
      bvn: Joi.number().integer(),
      nationality: Joi.string().required(),
      country_code: Joi.string().required(),
      state: Joi.string().required(),
      town: Joi.string().required(),
      address: Joi.string().required(),
      emergency_contact_one_name: Joi.string(),
      emergency_contact_one_phone: Joi.string(),
      emergency_contact_two_name: Joi.string(),
      emergency_contact_two_phone: Joi.string(),
