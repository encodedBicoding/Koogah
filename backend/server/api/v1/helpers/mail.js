...
export const createVerificationMail = function(user_email, user_obj, type) {
...
export const createCourierApprovalMail = function(userObj){
  const company_email = 'libera.delivery.service@gmail.com';
  let { first_name, last_name, approval_link, user_email, mobile_number, sex } = userObj;
  first_name = toSentenceCase.call(null, first_name);
  last_name = toSentenceCase.call(null, last_name);
